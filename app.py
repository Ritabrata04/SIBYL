...
def main():
  ...
  html1="""
    <div style="text-align:center; text-shadow: 0px 1px 1px black;">
      <h1> SIBYL.AI </h1>
    </div>
      """
  ...
  # with col2:
  #     st.image("./assets/sibylai.png", width=400, height=300)
  # with col2:
  #   st.image("./assets/sibylai.png", width=300)

  # with col3:
  #     st.image("./assets/Career _Outline.png")

  html2="""
    <div style="text-align:center; text-shadow: 0px 1px 2px black;">
  ...
  html3="""
    ...
    <div style="color:black; margin:80px; text-align:center;">
      Developed with ❤️ by <a href=https://github.com/tangorishi> Team07</a>
    </div>
      """

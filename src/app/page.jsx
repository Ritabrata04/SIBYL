      ...
      <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
        ...
        <div className="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
          ...
          <p className="mb-8 leading-relaxed">
            ...
            Aliquid ducimus vero itaque suscipit voluptatum. Hic accusantium eum dolorum pariatur architecto.
          </p>
          <div className="flex w-full justify-center items-end">
            <div className="relative mr-4 lg:w-full xl:w-1/2 w-2/4 md:w-full text-left">
              ...
              <input
                ...
                id="hero-field"
                name="hero-field"
                className="w-full bg-gray-800 rounded border bg-opacity-40 border-gray-700 focus:ring-2 focus:ring-blue-900 focus:bg-transparent focus:border-blue-500 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              />
            </div>
          ...
          <p className="text-sm mt-2 text-gray-500 mb-8 w-full">Lorem ipsum dolor sit amet.</p>

...
function page() {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Lorem ipsum dolor sit.</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Atque soluta similique velit recusandae amet nostrum. Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat eaque voluptatibus autem. </p>
    </div>
